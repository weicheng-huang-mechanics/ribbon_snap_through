...
setInput::setInput()
{
  ...
  AddOption("inputShear", "inputShear", inputShear);
  AddOption("speed", "speed", speed);
  AddOption("width", "width", width);
  AddOption("inputCompress", "inputCompress", inputCompress);
  AddOption("inputAngle", "inputAngle", inputAngle);
  AddOption("dataStep", "dataStep", dataStep);
}
