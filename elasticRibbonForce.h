#ifndef ELASTICRIBBONFORCE_H
#define ELASTICRIBBONFORCE_H

#include "eigenIncludes.h"
#include "elasticRod.h"
#include "timeStepper.h"

class elasticRibbonForce
{
public:
	elasticRibbonForce(elasticRod &m_rod, timeStepper &m_stepper);
	~elasticRibbonForce();

	void computeFribbon();
	void computeJribbon();

    VectorXd outputKappa;
    VectorXd outputTau;
...
private:
    ...
    VectorXd fTwisting_2;
    VectorXd fTwisting_4;
